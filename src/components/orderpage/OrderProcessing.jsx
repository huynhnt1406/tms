...
import { Wrapper, OrderRight } from "./style/OrderList";
import { ProductInfo, TableProduct } from "../TagsElements/Contact";
  ...
  const columns = [
    ...
    },
    {
      ...
      title: (
        <span>
          QTY
          <img alt="" src={process.env.PUBLIC_URL + '/asset/img/alertinfo.png'} />
        </span>
      ),
      dataIndex: "qty",
    },
      ...
      <HeaderProcessing>
        <OrderLeft>
          ...
          <Breadcrumb>
            ...
            <Breadcrumb.Item><Link to="/orderlist">Orders List</Link></Breadcrumb.Item>
