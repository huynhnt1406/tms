    ...
    const columns = [
        {
            ...
            render: (id) => <ElementTable style={{ color: '#367BF5' }}><Link to="/campaignConfig">{id}</Link></ElementTable>
        },
        {
            key: 'campaignname',
        ...
        <Wrapper>
            <Header>
                ...
                <OrderRight>
                    ...
                    <NewCampaign><ManageFont ><PlusOutlined />New Campaign</ManageFont></NewCampaign>
                </OrderRight>
            </Header>
